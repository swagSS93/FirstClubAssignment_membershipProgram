...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(SWAGGER_WHITELIST).permitAll() // Permit public access to Swagger UI
    ...
    // Maps JWT claims (e.g., realm_access.roles) to Spring GrantedAuthority with 'ROLE_' prefix
